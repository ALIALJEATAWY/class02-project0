...
var car=['TOYOTA'+'MAZDA'+'Honda'+'Porsche'+'TESLA'+'NISSAN'+'KIA'];
var guess;
for(var guess=1;guess<=7;guess++){
  var mycar=prompt('Enter my favorite car')
  switch(mycar){
    case 'TOYOTA':
      case 'MAZDA':
        case 'Honda':
          case 'Porsche':
            case 'TESLA':
              case 'NISSAN':
                case 'KIA':
                  alert('correct, that is one of my favorite cars');
                  console.log(mycar);
                  break;
                  default:
